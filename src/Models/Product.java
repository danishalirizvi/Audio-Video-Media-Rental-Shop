...
public class Product {
	...
	String TITL, DSCP, TITL_TYPE, FRMT_TYPE, Genre, Director, Band, Organiser, Manufacturer, Model;
	int RELS_YEAR;
	
	public Product(String tITL, String dSCP, String tITL_TYPE, String fRMT_TYPE, int rELS_YEAR) {
		super();
		TITL = tITL;
		DSCP = dSCP;
		TITL_TYPE = tITL_TYPE;
